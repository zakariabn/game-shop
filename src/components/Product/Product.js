...
const Product = ({ key, name, price, img }) => {
  return (
    <div className="bg-[#e1e1e1] p-2 w-[300px] rounded-2xl relative">
      ...
      <button className="bg-[#e67322] transition hover:bg-[#f18f0e] hover:rounded-b-2xl w-full h-[40px] absolute bottom-0 left-[-0] text-blue-900 font-bold">
        Add to List
      </button>
    </div>
  );
